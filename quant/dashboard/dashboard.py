...
class DashboardConfig:
    ...
    enabled_tabs: List[DashboardTab] = field(default_factory=lambda: list(DashboardTab))
...
class ExecutionQualityMetrics:
    ...
    slippage_distribution: Dict[str, int] = field(default_factory=dict)
    fill_rate: float = 0.0
...
class RiskDashboardMetrics:
    ...
    circuit_breaker_details: List[Dict] = field(default_factory=list)


@dataclass
class ComplianceDashboardMetrics:
    timestamp: datetime
    suitability_checks_24h: int = 0
    suitability_pass_rate: float = 1.0
    failed_suitability_checks: List[Dict] = field(default_factory=list)
    reports_generated_24h: int = 0
    reports_submitted_24h: int = 0
    reports_failed_24h: int = 0
    pending_reports: int = 0
    total_accounts: int = 0
    active_accounts: int = 0
    frozen_accounts: int = 0
    accounts_sync_failed: int = 0
    audit_logs_1h: int = 0
    audit_errors_1h: int = 0
...
class SystemMetrics:
    ...
    db_pool_usage_pct: float = 0.0
    mq_queue_depth: int = 0
    mq_publish_rate: float = 0.0
    mq_consume_rate: float = 0.0
