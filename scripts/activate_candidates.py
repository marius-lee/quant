#!/usr/bin/env python3
"""P43: 激活 reversal_5d / volatility_20d / amihud_20d 候选因子."""
import sqlite3, sys, os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

db = sqlite3.connect('data/market.db')
for name in ['reversal_5d', 'volatility_20d', 'amihud_20d']:
    db.execute(
        "UPDATE factor_registry SET status='active', status_reason='P43 candidate',"
